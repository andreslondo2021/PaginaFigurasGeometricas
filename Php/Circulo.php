...
<body>
    <center>
        <h1>Ingresamos al Circulo</h1>
        <div>
            <img src="../Img/FormImg_Circulo.jpg" alt="" height="300px" width="300px">
            
        </div>
        <form name="formulario"action="Circulo.php" method="POST">
        <div>
        ...
        if(isset($_POST['calcular'])){
          ...
          $Perimetro=((2*pi())*$Radio);
            $AreaT=round(($Perimetro*$Radio)/2,2);
