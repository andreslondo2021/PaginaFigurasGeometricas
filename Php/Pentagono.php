...
<head>
    ...
    <title>Pentagono Regular</title>
</head>
<body>
    <center>
        <h1>Ingresamos al Pentagono Regular</h1>
        <div>
            <img src="../Img/FormImg_Pentagono.png" alt="" height="300px" width="300px">
            
        </div>
        <form name="formulario"action="Pentagono.php" method="POST">
        <div>
