...
<head>
    ...
    <title>Poligono Regular</title>
</head>
<body>
    <center>
        <h1>Ingresamos al Poligono Regular</h1>
        <div>
            <img src="../Img/FormImg_PoligRegular.jpg" alt="" height="300px" width="300px">
            
        </div>
        <form name="formulario"action="PoligRegular.php" method="POST">
        <div>
        ...
        if(isset($_POST['calcular'])){
            ...
            $AreaT=round((($ValorLado*5)*$Apotema)/2,2);
